...
struct AboutUsView: View {
    ...
    private let features = [
        AppFeature(title: "AR Learning", description: "Interactive augmented reality experiences for enhanced learning", icon: "book.fill"),
        AppFeature(title: "IoT Integration", description: "Connect with IoT devices to monitor and analyze real-time data", icon: "network"),
        AppFeature(title: "Analytics", description: "Comprehensive data analysis and visualization tools", icon: "chart.bar.fill"),
        AppFeature(title: "Reports", description: "Generate detailed reports on environmental impact and usage", icon: "doc.text.fill")
    ]
